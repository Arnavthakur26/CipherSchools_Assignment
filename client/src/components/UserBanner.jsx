    ...
    <div className="pf-user-box  ml-[66.2px] min-h-[110px] bg-white sticky top-[59.8px] border-b border-[rgba(10,30,50,.1)]  ">
      <div className="pf-user-back bg-cover bg-[50%] bg-[url(https://www.cipherschools.com/static/media/ProfileCover.e525f2d51356332792cb.png)] flex justify-between flex-[1_1] ">
        <div className="userbox-left bg-gradient-to-r from-white to-transparent pt-4 pl-10 flex gap-[30px]">
          <div>
            <div className="w-[70px] h-[70px] flex items-center justify-center bg-[#bdbdbd]  rounded-full">
              <svg
            ...
            <div className="w-max rounded-full bg-[#202b47] p-[0.4rem] relative bottom-3 left-5">
              <svg
                viewBox="0 0 27 27"
                fill="none"
          ...
          <div className="user-greeting text-[#2c3d4f] leading-[1.25]">
            <div className="text-[20px]">Hello,</div>
            <div className="font-extrabold font-opensans text-[24px]">
              Osman Runge
            </div>
            <div>fayikis844@dogemn.com</div>
          </div>
        </div>
        <div className="userbox-right bg-gradient-to-l pr-[30px] from-white to-transparent flex items-center justify-center pl-20">
