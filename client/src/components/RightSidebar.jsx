...
const RightSidebar = () => {
  ...
  return (
    <>
      <div className="lg:flex hidden flex-col bg-white text-[#2c3d4f] pt-[0.8rem] fixed mt-[120px] right-0 justify-between h-[calc(100vh-59.8px)] font-sans border-l w-[67px] text-[9px] leading-[1.25]">
